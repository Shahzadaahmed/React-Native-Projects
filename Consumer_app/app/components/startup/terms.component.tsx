...
class Policy extends React.Component<Props, IState> {
    ...
    componentDidMount = () => {
        ...
        setTimeout(async () => {
            ...
            this.props.getPrivacyData({ data: { languageId: this.state.languageId, contentId: 13 } });
        }, 500);
            ...
            <View style={styles.container}>
                ...
                <View style={{}}>
                    <View style={styles.main} >
                        ...
                        <Text style={{ fontSize: 16, fontWeight: 'bold', alignSelf: 'center', color: Colors.AuthBackCrossButton, marginLeft: 80 }} >{this.state.contents?.headerText ? this.state.contents?.headerText : ''}</Text>
                    </View>
                    <ScrollView >
