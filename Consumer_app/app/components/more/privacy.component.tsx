...
// START THE PRIVACY PAGE FUNCTION THAT WILL BE IMPORTED IN MORE_STACK FILE.
const Privacy = (props: Props) =>
{
    ...
    return (
        <SafeAreaView style={styles.container}>
          <Header title={"Privacy Policy"} iconName={"arrow-back"} iconColor={theme.colors.darkGrey} textStyle={styles.textH5} onPress={()=>props.navigation.goBack()}/>
          <ScrollView>
