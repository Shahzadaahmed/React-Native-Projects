            ...
            >
                ...
                <View style={styles.mainView}>
                    <View style={styles.horizontal15}>
                        ...
                        <View style={[styles.row, {justifyContent: 'space-between', marginTop: '5%'}]}>
                            <View style={styles.row}>
                                <RestaunantLogo height={45} width={45} style={{marginRight: 10}} />
                                <View >
                                    <Text style={styles.subTitleText}>{hostDetail.title}</Text>
                                    <Text style={styles.subText}>{hostDetail.address}</Text>
                                </View>
                            </View>
                            <Ionicons
                                name={showIngredients ? "chevron-up" : "chevron-down"}
