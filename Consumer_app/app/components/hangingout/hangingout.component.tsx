...
const HangingOut = (props: Props) =>
{
    ...
    return (
        <View style={[styles.container, visibleSheet && styles.dimBG]}>
            {/* <View style={{}}> */}
            <MapView
                ref={_map}
                initialRegion={region}
                style={{...styles.container,opacity: visibleSheet ? 0.3 : 1}}
                onPress={() => setHeight(200)}
            ...
            >
                ...
                {markers.map((item, index) =>
                {
                    ...
                    return (
                        <Marker key={index} coordinate={item.coordinate} onPress={(e) => onMarkerPress(e)}>
            ...
            <View style={styles.backIcon}>
                <PressableIcon
                    ...
                    style={[styles.iconView, visibleSheet && styles.dimBG]}
                />
            </View>
            ...
            <BottomView
                ...
                showFilter={()=> setVisibleSheet(true)}
                closeFilter={()=> setVisibleSheet(false)}
                filter={visibleSheet}
